...
let # https://lazarusa.github.io/BeautifulMakie/surfWireLines/
    ...
    lightposition = (0, 0, 0), ambient = (0.65, 0.65, 0.65),
...
# Mackie is a plotting method in Julia very strong
# JSServe it's useful package of Julia

# Progress bars:
using ProgressLogging # https://github.com/JuliaLogging/ProgressLogging.jl
# it allows to define progress logs during aa loop based on basic logs julia's system
